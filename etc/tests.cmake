...
list(APPEND CMAKE_CTEST_ARGUMENTS --output-on-failure --stop-on-failure --timeout 25 -E 'speed_test|optimization')
...
add_custom_target (check2 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --stop-on-failure --timeout 25 -R '^byte_stream_|^reassembler_|^wrapping|^recv')

add_custom_target (check3 COMMAND ${CMAKE_CTEST_COMMAND} --output-on-failure --stop-on-failure --timeout 25 -R '^byte_stream_|^reassembler_|^wrapping|^recv|^send')
